...
public class LEDControl {
  ...
  private int[] colourToInt(Colour col){
    ...
    if(col == Colour.White) return new int[]{1,1,1};
  ...
  public void runCubeLights(){
    setFlash(new int[]{3,cnst.LED_STRING_LENGTH - 1}, Colour.Magenta, Colour.Black, 3000, 4, 250);
  }
  public void runConeLights(){
    setFlash(new int[]{3,cnst.LED_STRING_LENGTH - 1}, Colour.Yellow, Colour.Black, 3000, 4, 250);
  }
}