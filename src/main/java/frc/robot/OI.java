...
public class OI {
  ...
  public final JoystickButton start = new JoystickButton(controller, Button.kStart.value);
  public final JoystickButton back  = new JoystickButton(controller, Button.kBack.value);

  public final JoystickButton lb    = new JoystickButton(controller, Button.kLeftBumper.value);
  public final JoystickButton rb    = new JoystickButton(controller, Button.kRightBumper.value);
